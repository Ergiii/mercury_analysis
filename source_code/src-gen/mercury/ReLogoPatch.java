...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new sites and then executes a set of commands on the
	 * created sites.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<mercury.relogo.Site> sproutSites(int number, Closure closure) {
		AgentSet<mercury.relogo.Site> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Site");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("mercury.relogo.Site")
	public AgentSet<mercury.relogo.Site> sproutSites(int number) {
		return sproutSites(number,null);
	}
	...
	public AgentSet<mercury.relogo.Trader> sproutTraders(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("mercury.relogo.Trader")
	public AgentSet<mercury.relogo.Trader> sproutTraders(int number) {
	...
	public AgentSet<mercury.relogo.UserTurtle> sproutUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("mercury.relogo.UserTurtle")
	public AgentSet<mercury.relogo.UserTurtle> sproutUserTurtles(int number) {
