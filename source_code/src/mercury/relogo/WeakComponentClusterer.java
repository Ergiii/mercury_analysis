/* This code was copied from: https://github.com/dmihalcik/jung/blob/master/jung-algorithms/src/main/java/edu/uci/ics/jung/algorithms/cluster/WeakComponentClusterer.java
 * The only modification that was made was changing "HashSet" to "LinkedHashSet"
 */
...
public class WeakComponentClusterer<V,E> implements Transformer<Graph<V,E>, Set<Set<V>>> 
{
    ...
    public Set<Set<V>> transform(Graph<V,E> graph) {
        ...
        Set<Set<V>> clusterSet = new LinkedHashSet<Set<V>>();

        LinkedHashSet<V> unvisitedVertices = new LinkedHashSet<V>(graph.getVertices());

        while (!unvisitedVertices.isEmpty()) {
        	Set<V> cluster = new LinkedHashSet<V>();
